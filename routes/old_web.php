...
Route::get('/merchandise', function () {
    return view('dharman_homepage.merch');
});
Route::get('/kabinet/osis', function () {
    return view('dharman_kabinet.osis');
});
Route::get('/kabinet/mpk', function () {
    return view('dharman_kabinet.mpk');
});

// ThamNet
Route::get('/thamnet', function () {
    return view('dharman_thamnet.home');
});
Route::get('/thamnet/blog/{name}', function () {
    // find the blog name
    return view('dharman_thamnet.blog');
});
Route::get('/thamnet/blog/new', function () {
    return view('dharman_thamnet.create');
});
Route::get('/thamnet/blog/edit', function () {
    return view('dharman_thamnet.editor');
});

// ThamNet API
Route::post('/thamnet/api/create', function () {
    return 0;
});
...
// // OPEN HOUSE FRONTEND ily openhouse
