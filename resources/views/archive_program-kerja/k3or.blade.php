<x-layout title="K3OR">
    <main class="flex flex-col flex-grow w-full max-w-[1080px] h-full">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">K3OR</span>
                    </div>
                </li>
            </ol>
        </nav>
        <section class="py-8 w-full flex flex-col items-start space-y-16">
            <x-seksi title="k3or">
                <x-slot:name>Kreativitas, Keterampilan, Kewirusahaan, dan Olahraga</x-slot:name>
            </x-seksi>
            <div>
