                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex flex-col space-y-4">
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/sasbud/tsf/2016_1103_11100600514.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/sasbud/tsf/2016_1103_11304700514.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/sasbud/tsf/2016_1103_11481900514.webp') }} alt="">
                        </div>
                    </div>
                    <div class="flex flex-col space-y-4">
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/sasbud/tsf/2016_1103_13301800514.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/sasbud/tsf/2016_1103_13341100514.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/sasbud/tsf/2016_1103_13444600514.webp') }} alt="">
                        </div>
                    </div>
                </div>
            </div>
