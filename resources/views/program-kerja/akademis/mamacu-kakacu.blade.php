                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex flex-col space-y-4">
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/akad/mamacu/IMG_9462.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/akad/mamacu/2ED791FA-126D-4AF1-B65E-9C3481C61D8F-14995-00000172CD941F7D.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/akad/mamacu/9A52927D-C3C7-4F8E-9158-AB08ECC0E8FE-14995-00000173AF8B4CBB.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/akad/mamacu/7183D166-7212-4B43-B4B4-3D07FCDD5CFD-16002-00000192B1B71794.webp') }} alt="">
                        </div>
                    </div>
                    <div class="flex flex-col space-y-4">
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/akad/mamacu/DE7F474B-C06C-44E4-9D96-A8AB752E5292-14995-00000172BB640131.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/akad/mamacu/F397619D-6982-4C27-8D99-02F3B43A98C2-14995-00000174C3D1BB9E.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('/images/proker/akad/mamacu/FD4876E5-079D-4027-89FB-E220C47C6DE2-14995-00000172CA970AAF.webp') }} alt="">
                        </div>
                    </div>
                </div>
            </div>
