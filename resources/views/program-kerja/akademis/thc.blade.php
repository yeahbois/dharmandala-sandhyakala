            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Thamrin Homecoming</span>
                    </div>
                </li>
            </ol>
        </nav>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="flex flex-col space-y-4">
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('\images\proker\akad\thc\637A7804514.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('\images\proker\akad\thc\637A7880514.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('\images\proker\akad\thc\637A7931514.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('\images\proker\akad\thc\IMG_2856514.webp') }} alt="">
                        </div>
                    </div>
                    <div class="flex flex-col space-y-4">
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('\images\proker\akad\thc\IMG_2675514.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('\images\proker\akad\thc\IMG_2702514.webp') }} alt="">
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <img loading="lazy" class="h-auto max-w-full rounded-lg" src={{ asset('\images\proker\akad\thc\IMG_2739514.webp') }} alt="">
                        </div>
                    </div>
                </div>
            </div>
