...
<x-layout title="Thamnet - Open House 2025">
    ...
    <main class="container mx-auto px-4 py-12">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">📅 <strong>Tanggal:</strong></p>
            ...
            <p class="text-gray-600">⏰ <strong>Waktu:</strong> <span class="font-medium text-gray-800">06:30 WIB - 16:30 WIB</span></p>
            <p class="text-gray-600">📍 <strong>Lokasi:</strong> <span class="font-medium text-gray-800">SMAN Unggulan M.H. Thamrin</span></p>
        </div>
        ...
        <section class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 border rounded-lg shadow-md">
                    <p>⭐ <strong>𝗧𝗼𝘂𝗿 𝗱𝗲 𝗠𝗛𝗧 🌏</strong>: Jelajahi lingkungan SMAN Unggulan M.H. Thamrin!</p>
                </div>
                <div class="p-4 border rounded-lg shadow-md">
                    <p>⭐ <strong>𝗖𝗹𝗮𝘀𝘀 𝗦𝗶𝗺𝘂𝗹𝗮𝘁𝗶𝗼𝗻 🧑🏻‍🏫</strong>: Rasakan pengalaman menjadi siswa MHT.</p>
                </div>
                <div class="p-4 border rounded-lg shadow-md">
                    <p>⭐ <strong>𝗦𝗵𝗮𝗿𝗶𝗻𝗴 𝗦𝗲𝘀𝘀𝗶𝗼𝗻 💬</strong>: Dengar cerita dari alumni dan siswa.</p>
                </div>
                <div class="p-4 border rounded-lg shadow-md">
                    <p>⭐ <strong>𝗠𝗲𝗲𝘁 𝘁𝗵𝗲 𝗠𝗲𝗱𝗮𝗹𝗶𝘀𝘁 🏆</strong>: Berinteraksi dengan siswa berprestasi kami.</p>
                </div>
                <div class="p-4 border rounded-lg shadow-md">
                    <p>⭐ <strong>𝗠𝗛𝗧𝗵𝗶𝗻𝗴𝘀 🏫</strong>: Temukan apa yang membuat sekolah kami istimewa.</p>
                </div>
                <div class="p-4 border rounded-lg shadow-md">
                    <p>⭐ <strong>𝗧𝗿𝘆𝗼𝘂𝘁 𝗱𝗲𝗻𝗴𝗮𝗻 𝘁𝗼𝘁𝗮𝗹 𝗵𝗮𝗱𝗶𝗮𝗵 𝗝𝗨𝗧𝗔𝗔𝗡 𝗥𝗨𝗣𝗜𝗔𝗛!!! 💸</strong>: Ikuti tryout dengan total hadiah jutaan Rupiah!</p>
                </div>
            </div>
        </section>
        ...
        <section class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="p-4 border rounded-lg shadow-md">
                    <p>✔ Dapatkan wawasan berharga tentang program akademik dan ekstrakurikuler kami.</p>
                </div>
                <div class="p-4 border rounded-lg shadow-md">
                    <p>✔ Berinteraksi langsung dengan siswa, guru, dan alumni untuk mendengar pengalaman mereka.</p>
                </div>
                <div class="p-4 border rounded-lg shadow-md">
                    <p>✔ Ikuti kegiatan dan demonstrasi menarik secara langsung.</p>
                </div>
                <div class="p-4 border rounded-lg shadow-md">
                    <p>✔ Pelajari proses pendaftaran secara mendetail.</p>
                </div>
                <div class="p-4 border rounded-lg shadow-md">
                    <p>✔ Jelajahi fasilitas modern kami dan kehidupan asrama yang penuh warna.</p>
                </div>
            </div>
        </section>
        ...
        <section class="mb-12">
            ...
            <p class="mt-4">🎟 <strong>Harga Tiket:</strong></p>
            ...
            <p class="mt-4 font-bold">❗ Kuota terbatas untuk setiap batch! ❗</p>
        </section>
        ...
        <section class="mb-12">
            ...
            <p>📱 Instagram dan TikTok: <a href="https://instagram.com/osismpktthamrin" class="font-medium text-blue-600">@osismpktthamrin</a></p>
