<x-layout>
    ...
    <main class="flex flex-col flex-grow max-w-[1080px] w-full items-center h-full py-12 space-y-24">
            ...
            <div id="default-carousel" class="relative w-full" data-carousel="static">
                ...
                <div class="relative h-120 overflow-hidden rounded-lg md:h-96">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                        <img src="{{ Vite::asset('resources/images/one.jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ Vite::asset('resources/images/two.jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                    ...
                    <!-- Item 3 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="{{ Vite::asset('resources/images/three.jpg') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
                        <a href="https://www.instagram.com/thamrinolymcup" target="_blank" class="absolute block px-8 py-10 bottom-0 left-0 text-4xl font-bold text-white hover:underline">
                            JVLYN 9.0
                        </a>
                    </div>
        ...
        <section class="flex flex-row justify-center space-x-6">
            <div class="w-[250px]">
                <img src="{{ Vite::asset('resources/images/shidou.png') }}">
            </div>
        ...
        <section class="bg-white dark:bg-gray-900">
            ...
            <div class="my-8">
                <img src="{{ Vite::asset('resources/images/sae vs rin.png') }}" alt="">
            </div>
