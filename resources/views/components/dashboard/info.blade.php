                    ...
                    <div class="grid grid-cols-1 gap-8">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="quotes" rows="4" placeholder="Your inspirational message..."
                                class="w-full bg-surface-variant border-none ring-1 ring-outline/40 focus:ring-2 focus:ring-primary px-6 py-4 text-on-surface font-bold transition-all">{{ $user->quotes }}</textarea>
                        </div>
                        <div class="space-y-2">
