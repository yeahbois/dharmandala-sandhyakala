            ...
            <div class="bg-surface-variant/30 p-8 border border-outline/5">
                ...
                <form action="{{ route('dashboard.prestasi.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="pictures_urls[]" placeholder="https://... (banyak foto dipisah pakai spasi; contoh 'linkA linkB linkC'" class="w-full bg-surface border-none ring-1 ring-outline/20 focus:ring-2 focus:ring-primary px-6 py-3 text-on-surface font-bold transition-all">
                    </div>
                    <div class="space-y-2">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="important" value="1" id="p-imp" class="w-4 h-4 rounded-none border-outline">
