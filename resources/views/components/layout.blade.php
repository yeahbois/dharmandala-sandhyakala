...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ $title ?? 'Agradama Navaleksa' }}</title>
        ...
        <footer class="bg-white max-w-[1080px] w-full rounded-lg shadow-lg m-4 p-6 dark:bg-gray-800">
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    ...
                    <a href="#" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                    ...
                    <a href="https://x.com/osismpkthamrin" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                    ...
                    <a href="https://instagram.com/osismpkthamrin" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                    ...
                    <a href="https://www.youtube.com/@OSISMPKSMANUMHTHAMRIN" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
