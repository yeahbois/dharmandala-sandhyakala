-- SQL to create the adjust_quota function in Supabase
CREATE OR REPLACE FUNCTION adjust_quota(cat_key TEXT, delta INT)
RETURNS void AS $$
BEGIN
    UPDATE ticket_categories
    SET available_quota = available_quota + delta
    WHERE LOWER(category_name) = LOWER(cat_key);
END;
$$ LANGUAGE plpgsql;

-- SQL to reset and repopulate vip_seats (108 seats: A01-A12 to I01-I12)
